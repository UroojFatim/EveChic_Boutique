...
<head>
    ...
    <!-- Title  -->
    <title>EveChic Boutique - Detail page</title>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_thumb clearfix">
            <div class="product_thumbnail_slides owl-carousel">
                <img src="img/product-img/Casual/product-1.jpg" alt="">
                <img src="img/product-img/Casual/product-2.jpg" alt="">
                <img src="img/product-img/Casual/product-3.jpg" alt="">
            </div>
        </div>
